!(function (e) {
	...
	return (
		e.extend(!0, n.defaults, {
			dom:
				"<'columns'<'column is-6'l><'column is-6'f>><'columns'<'column is-12 table-container'tr>><'columns'<'column is-5'i><'column is-7'p>>",
			renderer: "bulma",
		}),
		e.extend(n.ext.classes, {
			sWrapper: "dataTables_wrapper dt-bulma",
			sFilterInput: "input is-rounded is-small",
			sLengthSelect: "input is-rounded is-small",
			sProcessing: "dataTables_processing panel",
			sPageButton: "pagination-link is-small",
		...
		(n.ext.renderer.pageButton.bulma = function (a, i, s, r, l, o) {
			var u,
				...
				x = function (t, n) {
					var i,
						...
						w = function (a) {
							a.preventDefault(),
								!e(a.currentTarget).is("[disabled]") &&
									!e(a.currentTarget).is("#table_ellipsis") &&
									p.page() != a.data.action &&
									p.page(a.data.action).draw("page");
						};
						...
						if (((v = n[i]), e.isArray(v))) x(t, v);
							...
							u &&
								((c = e("<li>", {
									...
									.appendTo(t)),
								a.oApi._fnBindAction(c, { action: v }, w),
								m++);
						}
				};
			try {
			...
			x(e(i).empty().html('<ul class="pagination-list"/>').children("ul"), r),
				c &&
					e(i)
						.find("[data-dt-idx=" + c + "]")
						.focus();
