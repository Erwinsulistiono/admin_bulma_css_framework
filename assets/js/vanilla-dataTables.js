  ...
  function (plugin) {
    ...
    Columns.prototype.sort = function (column, direction, init) {
      ...
      each(rows, function (tr) {
        ...
        var content = cell.hasAttribute("data-content")
    ...
    proto.render = function (type) {
      ...
      template += "<div class='column is-1 pr-0'>";
      template += o.layout.topFilter;
      template += "</div>";
      template += "<div class='column is-2'>entries</div>";
      template += "<div class='column is-offset-5'></div>";
      template += "<div class='column is-3'>";
      template += o.layout.topSearch;
      template += "</div>";
      template += "</div>";
      template += "<div class='dataTable-container'></div>";
      template += "<div class='dataTable-bottom'>";
      template += o.layout.bottomInfo;
      template += o.layout.bottomPage;
      template += "</div>";
      ...
      if (o.perPageSelect) {
        ...
        var wrap = "<div class='dataTable-dropdown dataTables_length'><label>";
        wrap += o.labels.perPage;
        wrap += "</label></div>";

        // Create the select
        var select = createElement("select", {
          class: "dataTable-selector input is-rounded is-small",
        });
      ...
      if (o.searchable) {
        var form =
          "<div class='dataTable-search'><input class='dataTable-input input is-rounded is-small' placeholder='" +
